...
namespace Insanity
{
    public abstract class MenuBase : IGamestate
    {
        ...
        public virtual void Draw(GameTime gameTime)
        {
            ...
            Vector2 fontOrigin = InsanityGame.GameFonts["TitleFont"].MeasureString(TitleText) / 2;
            spriteBatch.DrawString(InsanityGame.GameFonts["TitleFont"], TitleText, TitlePosition, Color.Crimson, 0, fontOrigin, 1, SpriteEffects.None, 0);
